...
//let x = trainValues;// [1.;2.5;3.1;4.;4.8;6.0;7.5;8.;9.1;15.]
//let y = trainSignal;// [1.6;2.1;1.4;4.;2.3;1.9;2.4;1.4;5.;2.9]
...
//    isValueShownAsLabel = true, drawingStyle = "Cylinder") 
//lc.boxplot(y = y, xname = "Players", yname = "Ratings", title = "Players' Ratings", color = Color.Blue, whiskerPercentile = 5, percentile = 30,
//    showAverage = false, showMedian = false, showUnusualValues = true)   
//lc.bubble(y = y, xname = "Players", yname = "Ratings", title = "Players' Ratings", color = Color.Blue) |> display    
//lc.scatter(y) + lc.line(y)
//lc.scatter(y, markerSize = 10) + lc.column() + lc.boxplot() + lc.line()  + lc.column(x) + lc.boxplot()
//lc.scatter(y, markerSize = 10) + lc.column() + (lc.line(x)  + lc.column()) + lc.scatter(markerSize = 20) 
//
