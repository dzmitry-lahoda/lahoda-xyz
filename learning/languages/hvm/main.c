          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            case _FIB_: {
              ...
              if (1) {
                ...
                u64 ret_5;
                if (get_tag(Cal(1, 1, cal_9)) == U32 && get_tag(Cal(1, 1, cal_12)) == U32) {
                  ret_5 = U_32(get_val(Cal(1, 1, cal_9)) + get_val(Cal(1, 1, cal_12)));
                  inc_cost(mem);
                } else {
                  u64 op2_6 = alloc(mem, 2);
                  link(mem, op2_6 + 0, Cal(1, 1, cal_9));
                  link(mem, op2_6 + 1, Cal(1, 1, cal_12));
                  ret_5 = Op2(ADD, op2_6);
                }
                u64 done = ret_5;
                link(mem, host, done);
